...
DailyAssessmentSchema.index({ student: 1, date: 1 }, { unique: true });
DailyAssessmentSchema.index({ student: 1, createdAt: -1 });
DailyAssessmentSchema.index({ riskLevel: 1, completedAt: -1 });

export const DailyAssessment: Model<IDailyAssessment> = model<IDailyAssessment>(
  "DailyAssessment",
